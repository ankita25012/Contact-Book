...
🧠 How It Works
Contacts are stored as dictionaries with keys like "name", "phone", "email", etc.

All contact dictionaries are stored in a list.

Functions are used to perform operations like add, search, update, delete.
